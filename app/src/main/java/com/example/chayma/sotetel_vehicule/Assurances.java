...
public class Assurances extends AppCompatActivity implements AdapterView.OnItemClickListener {
    public static String matricule;
    ListView list;
    List<Maintenance> mliste;
    Button ht,alim;
    Button bt1;
    VisiteAdapter a;
    Intent shareIntent ;

    public static Assurance vehicule = new Assurance();
    @Override
    public boolean onKeyDown(int keyCode, KeyEvent event)  {
        if (keyCode == KeyEvent.KEYCODE_BACK ) {
            //**********************************************
            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(Assurances.this);
            String f = preferences.getString("fonction", "");
//String f = obj.getString("fonction");
            if(f.equalsIgnoreCase("Chef Projet")) {
                Intent intent_next = new Intent(Assurances.this, MenuChefProjet.class);
                startActivity(intent_next);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_right);
                finish();
            }
            else   if(f.equalsIgnoreCase("Chef Parc")) {
                Intent intent_next = new Intent(Assurances.this, MenuChefParc.class);
                startActivity(intent_next);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_right);
                finish();
            }
            else   if(f.equalsIgnoreCase("responsable RH")) {
                Intent intent_next = new Intent(Assurances.this, MenuRH.class);
                startActivity(intent_next);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_right);
                finish();
            }
            else   if(f.equalsIgnoreCase("Directeur")) {
                Intent intent_next = new Intent(Assurances.this, MenuDirecteur.class);
                startActivity(intent_next);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_right);
                finish();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mliste = ListAssurance.liste;

        ArrayAdapter<Assurance> a = new ArrayAdapter<Assurance>(this,android.R.layout.simple_list_item_1,mliste);
        ListView lv =(ListView) findViewById(R.id.list);
        lv.setAdapter(a);
        a = new AssuranceAdapter(this, mliste);
        lv.setAdapter(a);
...
*/
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        Toast.makeText(Assurances.this, "index : "+i, Toast.LENGTH_LONG).show();
        if(i==0)
        {
            Intent intent = new Intent(Assurances.this,ListVisite.class) ;
