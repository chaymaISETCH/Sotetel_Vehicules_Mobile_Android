...
public class ServiceNotifVisite extends Service {
...
Intent i = new Intent(getApplicationContext(), ListVisite.class);
        i.putExtra("url","http://192.168.8.101/sotetel_pfe/notifVisite.php?date=true");
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this)
                        ...
                        .setStyle(new NotificationCompat.BigTextStyle().bigText("Visite Technique arrive bientôt à échéance"))
                        .setContentText("Visite Technique arrive bientôt à échéance")
                        .setDefaults(Notification.DEFAULT_ALL).setContentTitle("Visite Technique");
    ...
    class AsyncLogin extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(ServiceNotifVisite.this);
                SharedPreferences.Editor editor = preferences.edit();

                String couleur = preferences.getString(FAVORITE_COLOR, "");
                String FAVORITE_COLORR = "fav colorr";

                preferences = PreferenceManager.getDefaultSharedPreferences(ServiceNotifVisite.this);
                editor = preferences.edit();

                String couleurr = preferences.getString(FAVORITE_COLORR, "");
                // Enter URL address where your php file resides
                url = new URL("http://192.168.8.101/sotetel_pfe/notifVisite.php?date=hhjh");
...
String num="";
                ...
                Set<String> set = preferences.getStringSet("numsV", new HashSet<String>());

if(! set.containsAll(listNum)){
    set.addAll(listNum);
    editor.putStringSet("numsV", set);
    editor.commit();
    Toast.makeText(ServiceNotifVisite.this,"size : "+set.size(), Toast.LENGTH_SHORT).show();
createNotif("");
}
