...
public class ListAssuranceEx extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ListAssuranceEx.this, urld, Toast.LENGTH_LONG).show();
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(ListAssuranceEx.this);
        ...
        protected void onPreExecute() {
            ...
            pdLoading.show();
            Toast.makeText(ListAssuranceEx.this, "pre", Toast.LENGTH_LONG).show();
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                // Enter URL address where your php file resides
                    ...
                    url = new URL("http://192.168.8.101/sotetel_pfe/assurance.php?date=jhhj");
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(ListAssuranceEx.this, "Something went wrong. Connection Problem."+e.getMessage(), Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0 ; i < data_array.length() ; i++)
                {
                    ...
                    liste.add(vv);
                    Intent intent = new Intent(ListAssuranceEx.this, Assurances.class);
                ...
                Toast.makeText(ListAssuranceEx.this, "exe", Toast.LENGTH_LONG).show();
