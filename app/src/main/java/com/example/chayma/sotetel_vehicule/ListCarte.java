...
public class ListCarte extends AppCompatActivity {
    ...
    String mat;
    public static ArrayList<Carte> liste = new ArrayList<Carte>();
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(ListCarte.this);
        ...
        protected void onPreExecute() {
            ...
            pdLoading.show();
            Toast.makeText(ListCarte.this, "pre", Toast.LENGTH_LONG).show();
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                if(mat == null) {
                    ...
                    url = new URL("http://192.168.8.101/sotetel_pfe/carte.php");}
                else{
                    url = new URL("http://192.168.8.101/sotetel_pfe/carte.php?mat="+mat);
                }
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(ListCarte.this, "Something went wrong. Connection Problem."+e.getMessage(), Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0 ; i < data_array.length() ; i++)
                {
                    ...
                    Carte vv = new Carte();
//{"num":"1","solde":"2465.12","matricule":"tunis 1999"}
                    vv.setMat(obj.getString("matricule"));
                    vv.setNum(obj.getInt("num"));
                    vv.setSolde(obj.getDouble("solde"));



                    liste.add(vv);
                    Intent intent = new Intent(ListCarte.this, Cartes.class);
